...
#define LANGUAGE_FLASH_SIGN   20230323  // (YYYYMMDD) change if any keyword(s) in language pack is added or removed
#define ICON_FLASH_SIGN       20230323  // (YYYYMMDD) change if any icon(s) is added or removed
